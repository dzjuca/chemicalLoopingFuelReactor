...
% --------------------| Mass Balance - Gas   - Freeboard Phase |-----------
    f1gt = (- lr_mbrhs1Fcn(f1g, C_gs_dp, C_gs_lp, Tbed_2, Global, 'g_lp') ... 
            + lr_mbrhs2Fcn(f1g)... 
            + lr_mbrhs3Fcn(f1g));
    f2gt = (lr_mbrhs1Fcn(f2g) + lr_mbrhs2Fcn(f2g) + lr_mbrhs3Fcn(f2g));
    f3gt = (lr_mbrhs1Fcn(f3g) + lr_mbrhs2Fcn(f3g) + lr_mbrhs3Fcn(f3g));
    f4gt = (lr_mbrhs1Fcn(f4g) + lr_mbrhs2Fcn(f4g) + lr_mbrhs3Fcn(f4g));
    f5gt = (lr_mbrhs1Fcn(f5g) + lr_mbrhs2Fcn(f5g) + lr_mbrhs3Fcn(f5g));
    f6gt = (lr_mbrhs1Fcn(f6g) + lr_mbrhs2Fcn(f6g) + lr_mbrhs3Fcn(f6g));
% --------------------| Mass Balance - Solid - Freeboard Phase |-----------
    f1st = (lr_mbrhs1Fcn(f1s) + lr_mbrhs3Fcn(f1s));
    f2st = (lr_mbrhs1Fcn(f2s) + lr_mbrhs3Fcn(f2s));
    f3st = (lr_mbrhs1Fcn(f3s) + lr_mbrhs3Fcn(f3s));
